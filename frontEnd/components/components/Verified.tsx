...
import { VerifiedCertificateDetails } from "../Withdraw";
...
export const Verified = ({
  ...
  data: VerifiedCertificateDetails;
  open: boolean;
  close: () => void;
}) => {
  return (
        ...
        <ModalContent height="250px">
          ...
          <ModalBody mt={8}>
            <div className="flex space-x-3 w-[250px] mx-auto">
              ...
              <h1 className="w-[220px] mx-auto text-[#0FA958]">
                Course Certification Verified
              </h1>
            </div>
            <div className=" mx-auto">
              ...
              <div className={clsx("flex flex-wrap")}>
                ...
                <p className="text-sm">{data.addr}</p>
                <div>
